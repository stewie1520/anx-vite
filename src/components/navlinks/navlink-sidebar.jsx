...
export const NavLinkSidebar = ({ icon: Icon, title, to }) => {
  ...
  return (
    <NavLink to={to} className="text-gray-400" activeClassName="bg-gray-100 text-blue-400 dark:bg-slate-800">
      <div className={cx(navLinkCollapseClass, underCollapsedTextClass, 'flex items-center space-x-4 p-3 rounded cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-700')}>
